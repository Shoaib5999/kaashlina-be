...
CREATE TABLE "ShippingSettings" (
    ...
    "defaultShippingFee" DECIMAL(10,2) NOT NULL DEFAULT 99,
    "freeShippingThreshold" DECIMAL(10,2) NOT NULL DEFAULT 999,
    "isFreeShippingEnabled" BOOLEAN NOT NULL DEFAULT true,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "MagicCheckoutSession" (
    "id" TEXT NOT NULL,
    ...
    "shippingMethodsJson" JSONB NOT NULL,
    "cartItemsJson" JSONB,
    "expiresAt" TIMESTAMP(3) NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "MagicCheckoutSession_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "CmsSlider" (
    ...
    "imageUrl" TEXT,
    "imageUrlMobile" TEXT,
    "linkUrl" TEXT NOT NULL DEFAULT '/collection',
    "linkLabel" TEXT NOT NULL DEFAULT 'Discover Collection',
    "sortOrder" INTEGER NOT NULL DEFAULT 0,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "CmsHomeImage" (
    ...
    CONSTRAINT "CmsHomeImage_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "MagicCheckoutSession_razorpayOrderId_key" ON "MagicCheckoutSession"("razorpayOrderId");

-- CreateIndex
CREATE UNIQUE INDEX "MagicCheckoutSession_receipt_key" ON "MagicCheckoutSession"("receipt");

-- CreateIndex
CREATE INDEX "MagicCheckoutSession_expiresAt_idx" ON "MagicCheckoutSession"("expiresAt");
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductBundle_bundleProductId_childProductId_key" ON "ProductBundle"("bundleProductId", "childProductId");
...
-- CreateIndex
CREATE INDEX "CmsSlider_isActive_sortOrder_idx" ON "CmsSlider"("isActive", "sortOrder");

-- CreateIndex
CREATE UNIQUE INDEX "CmsHomeImage_slotKey_key" ON "CmsHomeImage"("slotKey");

-- CreateIndex
CREATE INDEX "CmsHomeImage_section_sortOrder_idx" ON "CmsHomeImage"("section", "sortOrder");

-- CreateIndex
CREATE INDEX "CmsHomeImage_isActive_section_idx" ON "CmsHomeImage"("isActive", "section");
...
-- AddForeignKey
ALTER TABLE "ProductBundle" ADD CONSTRAINT "ProductBundle_bundleProductId_fkey" FOREIGN KEY ("bundleProductId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProductBundle" ADD CONSTRAINT "ProductBundle_childProductId_fkey" FOREIGN KEY ("childProductId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProductBundle" ADD CONSTRAINT "ProductBundle_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_paymentModeId_fkey" FOREIGN KEY ("paymentModeId") REFERENCES "PaymentMode"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
